    ...
    <div>
      <div>
        ...
        <InfoPopup
          ...
          content={
            <div>
              <p>
                By enabling stat weighting, we assume that the number of cases
                is proportional to the number of tests taken.
              </p>
              <p>
                We find the maximum number of tests that were carried out on a
                single day, and treat the number of cases on that day as the
                true tests to cases ratio.
              </p>
              <p>
                ...
                data where we are able to get the test statistics (nation and
                UK)
              </p>
              <p>
      ...
      <div>
        <Checkbox
          ...
          onChange={() => setApplyPopulationScaling(!applyPopulationScaling)}
        />
      </div>
    </div>
  );
